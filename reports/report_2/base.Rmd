...
which shows that the log odds is linear in the predictors.
...
$B = 10$, $d = 5$, $\lambda = 0.1$, and $m = 15$ performs best, so this is what is chosen in the final model.
...
The result here is an overall accuracy of $\approx 78.5\%$, i.e. a misclassification rate of $11.5\%$.
