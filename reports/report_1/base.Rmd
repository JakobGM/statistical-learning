...
We will now fetch values for $X$, $x_0$, $\beta$ and $\sigma$.
...
This is what we would expect, from the fact that as $\lambda$ tends to infinity, the training data is not weighted at all.
It also reflects the bias-variance trade-off.
