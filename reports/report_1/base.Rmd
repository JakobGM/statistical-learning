...
tb %>% ggplot() +
  ...
  scale_x_continuous(limits = c(-90, 13), expand = c(0, 0)) +
  scale_y_continuous(limits = c(-90, 13), expand = c(0, 0)) +
  theme(
...
We prefer the argmax predictor since it has better accuracy.
